  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Success!",
          description: `You have been logged in successfully as a ${userType}.`,
        });
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Welcome to Shadiejo</CardTitle>
        ...
        <CardContent className="space-y-4">
          <Tabs value={userType} onValueChange={(value) => setUserType(value as "user" | "vendor")} className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="vendor">Login as Vendor</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value={userType} className="mt-6">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? "Logging in..." : `Login as ${userType === "vendor" ? "Vendor" : "User"}`}
                </Button>
              </form>
