...
const AddVenueModal = ({ open, onOpenChange, onVenueAdded }: AddVenueModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: data.detail || "Failed to add venue",
          variant: "destructive",
        });
      }
    } catch (error) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the details to add a new venue to your listings
          </DialogDescription>
        </DialogHeader>
